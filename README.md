...
| `FULL SCREEN (WIP)` | on / off | **work in progress.** Takes the shape of the device instead of a Game Boy screen and spends the room on **more rows** — same cells, as many as fit. Works on Gold too |
